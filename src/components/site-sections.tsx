...
const trust = [
  {
    ...
    lead: "12+ Years Experience",
    body: "Fellowship trained in Arthroscopy & Sports Medicine (India & Australia)",
  },
  {
    tag: "Surgical Volume",
    icon: Stethoscope,
    title: "Surgical Track Record",
    lead: "Knee, Shoulder & Ankle Arthroscopy",
    body: "Joint Replacement | Spine Injury | Foot & Ankle | Trauma",
  },
  {
    tag: "Recognition",
    icon: Trophy,
    title: "Memberships",
    lead: "KOA & MOA Member",
    body: "Senior Resident, SGITO | Senior Registrar, Fortis Hospital",
  },
];
